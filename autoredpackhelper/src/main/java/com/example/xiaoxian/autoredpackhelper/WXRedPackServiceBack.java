 ...
 **/
public class WXRedPackServiceBack extends AccessibilityService {
                        ...
                        if(node!=null){
                            ...
                            if(listNodes!=null){
                                ...
                                if(lqListNodes.toString()=="[]"){//红包还没被领取
                                    ...
                                    //获取开按钮
                                    List<AccessibilityNodeInfo> kaiNodes = nodeInfo2.findAccessibilityNodeInfosByViewId("com.tencent.mm:id/cyf");
                                    //获取 手慢了 提示语句的控件
